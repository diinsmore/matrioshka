...
from settings import TILES, RAMP_TILES, TILE_SIZE, MAP_SIZE, CELL_SIZE, RES, BIOMES, BIOME_WIDTH, Z_LAYERS, MACHINES, STORAGE, PIPE_BORDERS
...
class ProcGen:
    ...
    def get_tile_IDs() -> dict[str, int]:
        ...
        ids = [
            ...
            *[f'pipe {i}' for i in range(len(PIPE_BORDERS))], 
            *STORAGE.keys(), 
            'tree base',
            'item extended', 
        ]
