...
class Engine:
    def __init__(self, screen: pg.Surface):
        ...
        self.cam_offset = self.camera.offset

        self.proc_gen = ProcGen(screen, self.cam_offset, self.saved_data)
        ...
        self.biome_order = self.proc_gen.biome_order
        self.current_biome = self.proc_gen.current_biome
        ...
        self.all_sprites = self.sprite_manager.all_sprites
        self.human_sprites = self.sprite_manager.human_sprites
        self.animated_sprites = self.sprite_manager.animated_sprites
        ...
        self.player = Player( 
            ...
            Z_LAYERS['player'],
            [self.all_sprites, self.sprite_manager.player_sprite, self.human_sprites, self.animated_sprites], 
            self.tile_map,
            self.tile_IDs,
            self.current_biome,
            self.biome_order,
        ...
        self.ui = UI(self.screen, self.cam_offset, self.assets, self.inventory, self.sprite_manager, self.player)
        ...
        self.chunk_manager = ChunkManager(self.cam_offset)
